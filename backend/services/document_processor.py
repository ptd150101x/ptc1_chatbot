...
from models.knowledge import ProcessingTask, Document, DocumentChunk
from services.chunk_record import ChunkRecord
...
async def process_document_background(
    ...
    try:
        ...
        minio_client = get_minio_client()
        try:
            local_temp_path = rf"/tmp/temp_{task_id}_{file_name}"  # 使用系统临时目录
